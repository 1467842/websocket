			...
			createDateTimePicker = function( input ) {
				...
				calendar
					.on('click.xdsoft','td',function() {
						timerclick++;
						//20180209 wanghy 针对时间控件31号切换下月,日期多加一月的bug start
						var $this = $(this);
						if( $this.hasClass('xdsoft_disabled') )
							return false;
						_xdsoft_datetime.currentTime = new Date( $this.data('year') ,$this.data('month'),$this.data('date'),_xdsoft_datetime.currentTime.getHours(),_xdsoft_datetime.currentTime.getMinutes());
						var currentTime = _xdsoft_datetime.currentTime;
                        //20180209 wanghy 针对时间控件31号切换下月,日期多加一月的bug end
